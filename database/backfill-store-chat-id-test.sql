...
UPDATE store_inventory_test.store_info
...
-- 校验
SELECT store_id, store_name, chat_id FROM store_inventory_test.store_info
...
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpz23uu201ta3pq33tchfhdo';
-- [无匹配] 测试门店1001  (store_id=test1001)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='test1001';
-- [无匹配] 测试门店1002  (store_id=test1002)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='test1002';
-- [无匹配] 测试门店1003  (store_id=test1003)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='test1003';
-- [平局-疑误配] 象子茶铺茶临沧百树广场店  (store_id=cmpnw02q202aj3pk3i0a7084x)  最近似=临沧恒基广场店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpnw02q202aj3pk3i0a7084x';
-- [无匹配] 象子茶铺茶丽江旅游学院店  (store_id=cmpaocuzx00oq3pmbe7yvn9gg)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpaocuzx00oq3pmbe7yvn9gg';
-- [无匹配] 象子茶铺茶兴义店  (store_id=cmpw9lqu300wr3pq33cog9iq9)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpw9lqu300wr3pq33cog9iq9';
-- [回退-疑误配] 象子茶铺茶南屏街世纪广场店  (store_id=cmpwa93tr010v3pq3hzddyxs2)  最近似=昆明五华世纪广场店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpwa93tr010v3pq3hzddyxs2';
-- [平局-疑误配] 象子茶铺茶呈贡七彩云南第壹城店  (store_id=cmpaoctvq00e63pmbobapy64w)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpaoctvq00e63pmbobapy64w';
-- [平局-疑误配] 象子茶铺茶园西路店  (store_id=cmpnw02np029z3pk3olncxkvk)  最近似=保山施甸交通路店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpnw02np029z3pk3olncxkvk';
-- [平局-疑误配] 象子茶铺茶建水紫陶街店  (store_id=cmqrfhli506nm3pq3wevdtbvb)  最近似=丽江七星街店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmqrfhli506nm3pq3wevdtbvb';
-- [平局-疑误配] 象子茶铺茶弥勒印象街店  (store_id=cmpaoctz100f03pmbuyaf4h73)  最近似=丽江七星街店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpaoctz100f03pmbuyaf4h73';
-- [回退-疑误配] 象子茶铺茶昆明建工新城店  (store_id=cmpwa91ya010f3pq343o6pqxk)  最近似=昆明盘龙新迎新城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpwa91ya010f3pq343o6pqxk';
-- [无匹配] 象子茶铺茶昆明财经学院店  (store_id=cmpwa90gt01073pq3uw60hg23)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpwa90gt01073pq3uw60hg23';
-- [无匹配] 象子茶铺茶昭通金池店  (store_id=cmpway27w014d3pq3jvhup4pb)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpway27w014d3pq3jvhup4pb';
-- [无匹配] 象子茶铺茶楚雄彝海公园  (store_id=cmpnw02vr02bm3pk3tm33dbe0)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpnw02vr02bm3pk3tm33dbe0';
-- [无匹配] 象子茶铺茶福保店  (store_id=cmpaocu9f00hi3pmbmpvq836q)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpaocu9f00hi3pmbmpvq836q';
-- [无匹配] 象子茶铺茶贵州望谟店  (store_id=cmpnw02oa02a43pk35j04jbjg)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpnw02oa02a43pk35j04jbjg';
-- [回退-疑误配] 象子茶铺茶贵州黔西店  (store_id=cmpnw02rb02at3pk3xs15zeg9)  最近似=红河泸西店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmpnw02rb02at3pk3xs15zeg9';
-- [无匹配] 象子茶铺茶镇康南伞店  (store_id=cmp3hkhxa01yt3ps1buu08pso)  最近似=临沧中骏世界城店
-- UPDATE store_inventory_test.store_info SET chat_id='' WHERE store_id='cmp3hkhxa01yt3ps1buu08pso';
-- ============================================================
